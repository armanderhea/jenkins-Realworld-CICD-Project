...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                mvn sonar:sonar \
                -Dsonar.projectKey=JavaWebApp-QualityGate \
                -Dsonar.host.url=http://54.226.27.205:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: 'rk-27-aws-native-pipeline-alert', //update and provide your channel name
